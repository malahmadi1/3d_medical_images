...
parser.add_argument('--root_path', type=str, default='C:/dataset/pancreas', help='Name of Experiment') 
parser.add_argument('--root_pathlist', type=str, default='D:/deeplearning_Sanaz/SSL-contrastive/dataset/Pancreas', help='Name of Experiment')               # todo change dataset path
