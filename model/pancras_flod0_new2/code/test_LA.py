...
parser.add_argument('--root_path', type=str, default='C:/code/dataset/LASC2018/TrainingSet_new/', help='Name of Experiment')  # todo change dataset path
parser.add_argument('--root_pathlist', type=str, default='C:/code/deep_learning/MCF/dataset/LA', help='Name of Experiment') 
...
with open(FLAGS.root_pathlist + '/Flods/test0.list', 'r') as f:                                         # todo change test flod
    image_list = f.readlines()
image_list = [FLAGS.root_path +item.replace('\n', '')+"/wyc_mri_norm0_255.h5" for item in image_list]
